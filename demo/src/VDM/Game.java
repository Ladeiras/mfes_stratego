...
//
// Generated at 2013-12-18 by the VDM++ to JAVA Code Generator
  ...
  public Boolean checkToPositionColor (final Position p1, final Position p2) throws CGException {
    ...
    try {
      ...
      if (!(cond_3 = Boolean.valueOf(UTIL.equals(((((Piece)board.get(p2)).color).name), getOpponentColor(p1)))).booleanValue()) {
        ...
        if ((var2_12 = Boolean.valueOf(UTIL.equals(((((Piece)board.get(p2)).color).name), new String("null")))).booleanValue()) 
          var2_12 = Boolean.valueOf(UTIL.equals(((((Piece)board.get(p2)).rank).name), new String("null")));
        cond_3 = var2_12;
      }
